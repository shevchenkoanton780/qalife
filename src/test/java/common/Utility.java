...
public class Utility extends LoginPage {
    ...
    public static void SendMailSSLWithAttachment() {
        ...
        Session session = Session.getDefaultInstance(props,
                ...
                new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        ...
                        return new PasswordAuthentication("qalifetest@gmail.com", "Deploy19");
        ...
        try {
            ...
            message.setFrom(new InternetAddress("qalifetest@gmail.com"));

            // Set the recipient address
            message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("qalifetest@gmail.com"));
            ...
            File xx = new File(System.getProperty("user.home"), "/Desktop/qastarting_repo/target/failsafe-reports/");
